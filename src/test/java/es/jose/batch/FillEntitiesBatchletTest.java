...
public class FillEntitiesBatchletTest {
    private static final Logger logger = Logger.getLogger("FillEntitiesBatchletTest");
    ...
    */
    ...
    public void the_FillEntitiesBatchlet_finished_successfully() throws Exception {
        ...
        for (MyEntity e : r) {
            ...
            p = e.getPartition();
            // ... and partition must be < 3
            assertTrue(p < 3, "Partition must be < 3");
