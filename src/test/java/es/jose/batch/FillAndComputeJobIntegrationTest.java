...
import es.jose.batch.OnErrorChunkListener;
import es.jose.entities.MyEntity;
import es.jose.entities.EntityTestHelper;

@ExtendWith(WeldJunit5Extension.class)
public class FillAndComputeJobIntegrationTest {
    private static final Logger logger = Logger.getLogger("FillAndComputeJobTest");
    ...
    */
    ...
    public void integration_test() throws Exception {
        ...
        // ... and we need to create only 10 entities in 4 partitions
        Properties prop = new Properties();
        prop.setProperty("nmEntities", "10");
        prop.setProperty("partitions", "4");

        // ... and we have a BatchController
        BatchController controller = new BatchController(jobImp, prop);

        // WHEN 
        // ... the fillAndComputeJob Job is executed with the BatchController
        controller.startBatchJob();

        // ... and the Job has finished
        awaitTermination(controller.getExecutionId());
        ...
        // ... and we must have at least one entity in any each partition
        ...
        logger.log(Level.INFO, controller.getJobLog());
